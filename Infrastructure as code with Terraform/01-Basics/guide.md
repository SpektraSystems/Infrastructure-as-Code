...
> **NOTE**: The first time you launch Cloud Shell from a new folder, you will be asked to set up the web application. Select Open to continue and create an storage account for cloud bash in empty resource group(IoC-02-XXXXX).
