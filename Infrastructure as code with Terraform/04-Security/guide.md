...
- Apply the changes
>**NOTE** Prior to running any Terraform commands in Azure Cloud Shell, make sure that you select you directory in cloudshell. you can use "cd lab04-part1" command to goto your directory.
#### CHEAT SHEET
